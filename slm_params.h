...
#define GREEN_UPPER_LIMIT  67.0 // dBA, maximum noise level for which the indicator stays green
#define YELLOW_UPPER_LIMIT 77.0 // dBA, maximum noise level for which the indicator stays yellow
